...
export class HomeComponent implements OnInit {
  ...
  textos = [
    ...
    { titulo: 'Mindfulness y concentración', desc: 'Técnicas para mantener el foco durante la lectura.', badge: 'Nuevo', tiempo: '4 min', nivel: 'Básico', color: 'linear-gradient(135deg, #7c3aed, #db2777)' },
  ...
  textos2 = [
    ...
    { titulo: 'Por qué leer ficción', desc: 'La ficción desarrolla empatía, creatividad y comprensión.', badge: 'Literatura', tiempo: '6 min', nivel: 'Intermedio', color: 'linear-gradient(135deg, #065f46, #db2777)' }
  ];
